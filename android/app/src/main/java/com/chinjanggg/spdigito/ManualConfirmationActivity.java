...
public class ManualConfirmationActivity extends AppCompatActivity {

    ApiService apiService;
    private static final int REQUEST_EXIT = 1;
    TextInputEditText pidCF, nameCF, addressCF, sysCF, diaCF, pulseCF;
    String resultData;
    FloatingActionButton btnCancel, btnEdit, btnSave;
    Intent intent;
    Bundle extras;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnCancel.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ManualConfirmationActivity.this.finish();
            }
        });
    ...
    private void editData() {
        Intent resIntent = new Intent(ManualConfirmationActivity.this, ManualEditActivity.class);
    ...
    private void confirmSaving() {
        new AlertDialog.Builder(ManualConfirmationActivity.this)
